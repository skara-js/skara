function D(a,t={},s=[]){return{tag:a,props:t||{},children:Array.isArray(s)?s:[s].filter(Boolean)}}function e(a,t,...s){let n=s.flat().filter(o=>o!=null&&o!==!1);return D(a,t,n)}function v(a){if(typeof a=="string"||typeof a=="number")return document.createTextNode(String(a));if(typeof a.tag=="function")return v(a.tag(a.props));let t=document.createElement(a.tag);return Object.entries(a.props||{}).forEach(([s,n])=>{if(s.startsWith("on")&&typeof n=="function"){let o=s.slice(2).toLowerCase();t.addEventListener(o,n)}else s==="className"?t.className=n:s==="style"&&typeof n=="object"?Object.assign(t.style,n):s!=="children"&&t.setAttribute(s,n)}),a.children.forEach(s=>{t.appendChild(v(s))}),t}function I(a,t,s,n=0){if(!s)a.appendChild(v(t));else if(!t)a.removeChild(a.childNodes[n]);else if(P(t,s))a.replaceChild(v(t),a.childNodes[n]);else if(t.tag){let o=t.children.length,c=s.children.length;for(let l=0;l<o||l<c;l++)I(a.childNodes[n],t.children[l],s.children[l],l)}}function P(a,t){return typeof a!=typeof t||typeof a=="string"&&a!==t||a.tag!==t.tag}var g=null,x=0,r=[];function u(a){let t=x++;r[t]===void 0&&(r[t]=a);let s=n=>{typeof n=="function"?r[t]=n(r[t]):r[t]=n,g&&g.scheduleRender&&g.scheduleRender()};return[r[t],s]}function E(a,t){let s=x++;r[s]===void 0&&(r[s]={dependencies:void 0,cleanup:null});let n=r[s];(!t||!n.dependencies||t.some((c,l)=>c!==n.dependencies[l]))&&(n.cleanup&&n.cleanup(),n.cleanup=a()||null,n.dependencies=t)}function A(a,t){let s=null,n=!1;function o(){x=0;let l=a();s?I(t,l,s):t.appendChild(v(l)),s=l,n=!1}function c(){n||(n=!0,requestAnimationFrame(o))}return g={scheduleRender:c},o(),c}function T(){let[a,t]=u("home"),[s,n]=u(0),[o,c]=u([]),[l,N]=u(""),[b,w]=u(0),[m,k]=u(!1),[p,y]=u("counter"),[S,f]=u(!1);E(()=>{let i=null;return m&&(i=setInterval(()=>{w(d=>d+1)},1e3)),()=>{i&&clearInterval(i)}},[m]);let C=()=>{l.trim()&&(c([...o,{id:Date.now(),text:l,done:!1}]),N(""))},j=i=>{c(o.map(d=>d.id===i?{...d,done:!d.done}:d))},R=i=>{c(o.filter(d=>d.id!==i))},B=i=>{let d=Math.floor(i/60),$=i%60;return`${d.toString().padStart(2,"0")}:${$.toString().padStart(2,"0")}`},L={counter:`import { h, useState } from 'skara-js';
