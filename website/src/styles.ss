/* 🏛️ SKARA.JS - ULTIMATE STYLING SYSTEM */
/* Ancient wisdom meets cutting-edge design */
...
.hero-section::before {
  ...
  background: radial-gradient(circle at 30% 20%, rgba(139, 92, 246, 0.1) 0%, transparent 50%),
              radial-gradient(circle at 70% 80%, rgba(56, 189, 248, 0.1) 0%, transparent 50%);
  pointer-events: none;
}
...
.hero-title {
  ...
  font-weight: 900;
  margin-bottom: 32px;
  background: linear-gradient(135deg, #38bdf8 0%, #e879f9 50%, #f0abfc 100%);
  background-clip: text;
  -webkit-background-clip: text;
  -webkit-text-fill-color: transparent;
...
.neon-button:hover {
  ...
  box-shadow: 0 20px 40px -5px rgba(56, 189, 248, 0.4);
}
...
::-webkit-scrollbar-thumb:hover {
  background: linear-gradient(to bottom, #7dd3fc, #f0abfc);
}
